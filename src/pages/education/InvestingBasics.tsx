    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className={`flex-grow ${isMobile ? 'pt-0' : 'pt-14 md:pt-16'} px-4 py-6`}>
        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl font-bold mb-2">Investing Basics</h1>
          <p className="text-gray-600 mb-6">Learn the fundamentals of investing, from key terminology to understanding different asset classes.</p>
