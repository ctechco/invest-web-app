          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardContent className="p-4">
                ...
                <h3 className="font-bold mb-1">Getting Started with Stock Investing</h3>
                <p className="text-sm text-gray-600 mb-2">
                  A beginner's guide to understanding the stock market and making your first investment.
                </p>
                <div className="text-xs text-gray-500">12:45 • 25K views</div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <h3 className="font-bold mb-1">How to Read Financial Statements</h3>
                <p className="text-sm text-gray-600 mb-2">
                  Learn to analyze company performance by understanding key financial documents.
                </p>
                <div className="text-xs text-gray-500">18:30 • 18K views</div>
              </CardContent>
            </Card>
          </div>
        </div>
