...
const Hero = () => {
  ...
  return (
    <div className="relative bg-gradient-to-r from-futurewave-purple to-[#6E59A5] text-white pt-24 pb-16 md:pt-32 md:pb-20">
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg lg:text-xl text-white opacity-90 mb-6 md:mb-8 px-1">
          ...
          <div className="mt-10 md:mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center">
            <div className="p-3 md:p-4">
              <div className="text-white text-2xl md:text-3xl font-bold">$2.5B+</div>
              <div className="text-xs md:text-sm text-white opacity-80">Assets Under Management</div>
            </div>
            <div className="p-3 md:p-4">
              <div className="text-white text-2xl md:text-3xl font-bold">1000+</div>
              <div className="text-xs md:text-sm text-white opacity-80">Satisfied Clients</div>
            </div>
            <div className="p-3 md:p-4">
              <div className="text-white text-2xl md:text-3xl font-bold">15+</div>
              <div className="text-xs md:text-sm text-white opacity-80">Years Experience</div>
            </div>
            <div className="p-3 md:p-4">
              <div className="text-white text-2xl md:text-3xl font-bold">24/7</div>
              <div className="text-xs md:text-sm text-white opacity-80">Expert Support</div>
            </div>
          </div>
        </div>
      </div>
